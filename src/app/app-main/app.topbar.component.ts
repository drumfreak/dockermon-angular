    ...
    },
    {
      ...
      items: [
        [
          ...
          {
            label: 'UTILITIES 2',
            items: [{ label: 'FlexBox', icon: 'pi pi-fw pi-directions', routerLink: ['utilities/flexbox'] }],
          },
        ],
        [
          {
            label: 'UTILITIES 3',
            items: [{ label: 'Icons', icon: 'pi pi-fw pi-search', routerLink: ['utilities/icons'] }],
          },
          {
            label: 'UTILITIES 4',
            items: [
